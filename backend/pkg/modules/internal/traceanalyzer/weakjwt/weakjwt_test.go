...
func TestWeakJWT(t *testing.T) {
	testcases := []struct {
		...
		{auth: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjowLCJwYXNzd29yZCI6ImJsYSJ9.HoI84Px0J9oVujFgBvY42PF9xaBz0xCDJzuono4qo40", wanted: []utils.TraceAnalyzerAnnotation{&AnnotationSensitiveContentInClaims{SensitiveWords: []string{"password"}}}},
		...
		{auth: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzc24iOiI5OTk5IiwiaXAiOiIxOTIuMS4xLjEiLCJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.bySqmwlwljWpXLWZ4jlkb_ST3VtuPK2Sui79jkGUEIE", wanted: []utils.TraceAnalyzerAnnotation{&AnnotationSensitiveContentInClaims{SensitiveWords: []string{"ip", "ssn"}}}},
		{auth: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImNvdmlkX3Bvc2l0aXZlIjp0cnVlfQ.eyJzc24iOiI5OTk5IiwiaXAiOiIxOTIuMS4xLjEiLCJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.kiDLC2Kl-3diNJ_8k-LAdQpNjWmPzmJ1YXvh-p2J9T4", wanted: []utils.TraceAnalyzerAnnotation{&AnnotationSensitiveContentInHeaders{SensitiveWords: []string{"covid_positive"}}, &AnnotationSensitiveContentInClaims{SensitiveWords: []string{"ip", "ssn"}}}},
		...
		{auth: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzM4NCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiZXhwIjo5OTk5OTk5OTk5OSwicGFzc3dvcmQiOiJibGEifQ.tCIFaW7882WmxIGednahpwN-1jEqOkkwgS0W1x5F35psVTACPcpbPw-P8K9CfQM3",
		 wanted: []utils.TraceAnalyzerAnnotation{
			 &AnnotationWeakSymetricSecret{WeakKey: []byte("AllYourBase"), WeakKeyLen: 11},
			 &AnnotationSensitiveContentInClaims{SensitiveWords: []string{"password"}},
