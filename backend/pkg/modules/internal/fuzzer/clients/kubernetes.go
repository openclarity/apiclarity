...
func (l *K8sClient) TriggerFuzzingJob(apiID uint32, endpoint string, securityItem string) error {
...
func (l *K8sClient) getEnvs(apiID uint32, endpoint string, securityItem string) []v1.EnvVar {
	envs := []v1.EnvVar{
		{
			Name:  uriEnvVar,
			Value: endpoint,
