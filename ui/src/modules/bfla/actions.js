...
const putBflaApiAuthModelApprove = (apiID) => axios.put(utils.BFLA_API_AUTH_MODEL_APPROVE_URL(apiID));
const putBflaApiAuthModelDeny = (apiID) => axios.put(utils.BFLA_API_AUTH_MODEL_DENY_URL(apiID));
