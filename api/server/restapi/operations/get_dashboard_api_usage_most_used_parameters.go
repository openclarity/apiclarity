...
// GetDashboardAPIUsageMostUsedParams contains all the bound params for the get dashboard API usage most used operation
...
func (o *GetDashboardAPIUsageMostUsedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
