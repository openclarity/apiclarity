...
func (o *GetAPIEventsEventIDURL) WithBasePath(bp string) *GetAPIEventsEventIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAPIEventsEventIDURL) Build() (*url.URL, error) {
	...
	var _path = "/apiEvents/{eventId}"

	eventID := swag.FormatUint32(o.EventID)
	if eventID != "" {
		_path = strings.Replace(_path, "{eventId}", eventID, -1)
	} else {
		return nil, errors.New("eventId is required on GetAPIEventsEventIDURL")
	}
...
func (o *GetAPIEventsEventIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAPIEventsEventIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAPIEventsEventIDURL")
	}
