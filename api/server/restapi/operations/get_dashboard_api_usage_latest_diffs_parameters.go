...
// GetDashboardAPIUsageLatestDiffsParams contains all the bound params for the get dashboard API usage latest diffs operation
...
func (o *GetDashboardAPIUsageLatestDiffsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
