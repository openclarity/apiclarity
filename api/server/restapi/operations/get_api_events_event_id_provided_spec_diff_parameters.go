...
// GetAPIEventsEventIDProvidedSpecDiffParams contains all the bound params for the get API events event ID provided spec diff operation
...
func (o *GetAPIEventsEventIDProvidedSpecDiffParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAPIEventsEventIDProvidedSpecDiffParams) bindEventID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if err != nil {
		return errors.InvalidType("eventId", "path", "uint32", raw)
	}
	o.EventID = value
