...
// GetAPIEventsEventIDParams contains all the bound params for the get API events event ID operation
...
func (o *GetAPIEventsEventIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAPIEventsEventIDParams) bindEventID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
