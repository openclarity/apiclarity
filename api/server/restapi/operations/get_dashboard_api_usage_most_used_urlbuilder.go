...
func (o *GetDashboardAPIUsageMostUsedURL) WithBasePath(bp string) *GetDashboardAPIUsageMostUsedURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDashboardAPIUsageMostUsedURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/dashboard/apiUsage/mostUsed"
...
func (o *GetDashboardAPIUsageMostUsedURL) String() string {
...
func (o *GetDashboardAPIUsageMostUsedURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDashboardAPIUsageMostUsedURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDashboardAPIUsageMostUsedURL")
	}
