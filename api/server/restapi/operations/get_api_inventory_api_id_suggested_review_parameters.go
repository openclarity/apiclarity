...
// GetAPIInventoryAPIIDSuggestedReviewParams contains all the bound params for the get API inventory API ID suggested review operation
...
func (o *GetAPIInventoryAPIIDSuggestedReviewParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAPIInventoryAPIIDSuggestedReviewParams) bindAPIID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
