...
// DeleteAPIInventoryAPIIDSpecsProvidedSpecParams contains all the bound params for the delete API inventory API ID specs provided spec operation
...
func (o *DeleteAPIInventoryAPIIDSpecsProvidedSpecParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteAPIInventoryAPIIDSpecsProvidedSpecParams) bindAPIID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
