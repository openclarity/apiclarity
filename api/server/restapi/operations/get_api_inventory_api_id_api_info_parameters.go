...
// GetAPIInventoryAPIIDAPIInfoParams contains all the bound params for the get API inventory API ID API info operation
...
func (o *GetAPIInventoryAPIIDAPIInfoParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAPIInventoryAPIIDAPIInfoParams) bindAPIID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
