...
// GetAPIInventoryAPIIDReconstructedSwaggerJSONParams contains all the bound params for the get API inventory API ID reconstructed swagger JSON operation
...
func (o *GetAPIInventoryAPIIDReconstructedSwaggerJSONParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAPIInventoryAPIIDReconstructedSwaggerJSONParams) bindAPIID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
