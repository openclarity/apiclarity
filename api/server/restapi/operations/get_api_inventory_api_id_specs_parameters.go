...
// GetAPIInventoryAPIIDSpecsParams contains all the bound params for the get API inventory API ID specs operation
...
func (o *GetAPIInventoryAPIIDSpecsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAPIInventoryAPIIDSpecsParams) bindAPIID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
