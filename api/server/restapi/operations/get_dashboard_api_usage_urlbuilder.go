...
func (o *GetDashboardAPIUsageURL) WithBasePath(bp string) *GetDashboardAPIUsageURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDashboardAPIUsageURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDashboardAPIUsageURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDashboardAPIUsageURL")
	}
