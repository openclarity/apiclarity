...
func (o *PostControlNewDiscoveredAPIsURL) WithBasePath(bp string) *PostControlNewDiscoveredAPIsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostControlNewDiscoveredAPIsURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/control/newDiscoveredAPIs"
...
func (o *PostControlNewDiscoveredAPIsURL) String() string {
...
func (o *PostControlNewDiscoveredAPIsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostControlNewDiscoveredAPIsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostControlNewDiscoveredAPIsURL")
	}
