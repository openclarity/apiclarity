...
// PostTelemetryParams contains all the bound params for the post telemetry operation
...
func (o *PostTelemetryParams) bindXTraceSourceToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
